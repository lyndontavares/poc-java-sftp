...
public class MySftpServer {
    ...
    private void start() throws IOException {
        ...
        //exec: ssh-keygen -t rsa pegue o conteudo gerado e coloque no arquivio_auth_key
        sshd.setPublickeyAuthenticator(new AuthorizedKeysAuthenticator(new File("src/main/resources/auth_key")));
        sshd.start();
